...
WebUI.doubleClick(findTestObject('Object Repository/div_Happy Ninja quantity_quantity-button qu_b6dd9e'))

WebUI.click(findTestObject('Object Repository/div_Happy Ninja quantity_quantity-button qu_b6dd9e'))
